<template>
  <div
    :class="{ 'pb-20': displayActionButtons }"
    class="w-full min-h-screen sm:w-2/3 sm:p-2 sm:border sm:rounded-xl border-black bg-white absolute z-50 top-0 right-0 transform sm:translate-y-28 sm:-translate-x-24"
  >
    <div
